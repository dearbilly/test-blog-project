                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Kategoyalar ro`yxati</h3>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                                <a href="{{ route('categories.create') }}" class="btn btn-primary mb-3">Kategoriya qo`hish</a>
                                @if (count($categories))
                                ...
                                @else
                                    <p>Xozircha kategoriyalar yo`q</p>
                                @endif
                            </div>
                            <!-- /.card-body -->
