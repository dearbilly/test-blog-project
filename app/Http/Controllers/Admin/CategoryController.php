...
//        $category->slug = null;
        ...
        return redirect()->route('categories.index')->with('success', 'Kategoriya muvaffaqiyatli tahrirlandi');
    }
    ...
    public function destroy($id)
    {
        ...
        if ($category->posts->count()){
            return redirect()->route('categories.index')->with('error', 'Ushbu kategoriyada post bor');
        }
        $category->delete();
//        Category::destroy($id);
